                            ...
                            <div className="div">
                                ...
                                <div className="top-workers">
                                    <div className="overlap-group-2">
                                        <div className="rec" />
                                        <div className="text-wrapper">أفضل المقاولين</div>
                    ...
                    <div className="box">
                        <div className="mail-button-wrapper">
                            <div className="mail-button">
                                <div className="overlap-group">
                                    <div className="text-wrapper">تجديد بكل سهولة</div>
                    ...
                    <div className="label">
                        <div className="renovate-your-home-wrapper">
                            <h1 className="renovate-your-home">
                                <span className="text-wrapper">قم بتجديد منزلك مع</span>
                ...
                <Text>
                    <div className="label">
                        <div className="p-wrapper">
                            <p className="text-wrapper">نحن نساعدك في العثور على أفضل مقاول لتجديد منزلك</p>
                        </div>
                    </div>
                </Text>
                <Button>
                        ...
                        <div className="box">
                            <div className="find-contractors-box-wrapper">
                                <div className="find-contractors-box">
                                    <div className="overlap-group">
                                        <div className="rectangle" />
                                        <div className="text-wrapper">ابحث عن المقاولين</div>
                                    </div>
                                </div>
                            </div>
                        </div>
